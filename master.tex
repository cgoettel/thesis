...
\byustylesetup{%
    ...
    deptname          = Department of (department name),
    committeechairman = Barry Lunt,
    committeemembera  = Alexander G. Bell,
    committeememberb  = Isambard K. Brunel,
...
\title{First Line of Your Thesis/Dissertation Title\\Second Line of Title if Necessary\\Three Line Limit}%Ira A. Fulton College\\ of Engineering and Technology}
\author{Isaac Newton}

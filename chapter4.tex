...
The Pearson correlation coefficient for each major GPA and the corresponding AMSS index are $p>0.05$ so I am unable to say that there is a correlation between the two.
